...
from tg_notifications_admin.schemas.users import UserOutSchema
from tg_notifications_admin.schemas.token import TokenData
...
security = OAuth2PasswordBearerCookie(token_url="/login", auto_error=False)
